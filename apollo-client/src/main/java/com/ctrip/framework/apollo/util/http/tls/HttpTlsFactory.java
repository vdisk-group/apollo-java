 ...
 */
public interface HttpTlsFactory extends Ordered {
  ...
  /**
   * Creates a new {@link HttpTlsContext} using the given {@link HttpTlsConfig}.
   */
  @Nullable
  HttpTlsContext create(HttpTlsConfig tlsConfig);
}
