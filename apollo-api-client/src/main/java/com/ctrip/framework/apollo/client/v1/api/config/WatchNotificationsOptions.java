...
public class WatchNotificationsOptions {
  ...
  WatchNotificationsOptions(Builder builder) {
  ...
  public static final class Builder {
    ...
    public WatchNotificationsOptions build() {
      return new WatchNotificationsOptions(this);
    }
  }
}
