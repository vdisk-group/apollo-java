...
import com.ctrip.framework.apollo.transport.grpc.v1.config.ApolloGrpcTransportConfigClient;

public class GrpcApolloTransportConfigClientManager implements
    ApolloTransportConfigClientManager {

  private final ApolloTransportConfigClient client;

  public GrpcApolloTransportConfigClientManager() {
    ApolloGrpcChannelManager channelFactory = ApolloInjector.getInstance(
        ApolloGrpcChannelManager.class);
    this.client = new ApolloGrpcTransportConfigClient(channelFactory);
  }
