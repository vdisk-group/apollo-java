...
public class ApolloTransportGetConfigResult {
  ...
  ApolloTransportGetConfigResult(Builder builder) {
  ...
  public String toString() {
    return new StringJoiner(", ", ApolloTransportGetConfigResult.class.getSimpleName() + "[", "]")
        // fields
  ...
  public static final class Builder {
    ...
    public ApolloTransportGetConfigResult build() {
      return new ApolloTransportGetConfigResult(this);
    }
  }
}
