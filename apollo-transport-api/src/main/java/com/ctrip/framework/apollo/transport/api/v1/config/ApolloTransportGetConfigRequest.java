...
public class ApolloTransportGetConfigRequest {
  ...
  ApolloTransportGetConfigRequest(Builder builder) {
  ...
  public String toString() {
    return new StringJoiner(", ",
        ApolloTransportGetConfigRequest.class.getSimpleName() + "[", "]")
        // fields
  ...
  public static final class Builder {
    ...
    public ApolloTransportGetConfigRequest build() {
      return new ApolloTransportGetConfigRequest(this);
    }
  }
}
